...
namespace Wisp.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260911092412_AddDiscoveryPublishedAt")]
    partial class AddDiscoveryPublishedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wisp.Core.Discovery.DiscoveredTrack", b =>
                {
                    ...
                    b.HasIndex("DiscoverySourceId", "PublishedAt");
            ...
            modelBuilder.Entity("Wisp.Core.MixPlans.MixPlan", b =>
                {
                    ...
                    b.Property<Guid?>("RecommendationScopePlaylistId")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("RecommendationScopePlaylistId");
            ...
            modelBuilder.Entity("Wisp.Core.Playlists.Playlist", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Wisp.Core.Playlists.PlaylistTrack", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Wisp.Core.Wanted.WantedTrack", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("MatchedLocalTrackId");

                    b.HasIndex("Artist", "Title")
                        .IsUnique();

                    b.ToTable("WantedTracks");
                });
            ...
            modelBuilder.Entity("Wisp.Core.MixPlans.MixPlan", b =>
                {
                    b.HasOne("Wisp.Core.Playlists.Playlist", null)
                        .WithMany()
                        .HasForeignKey("RecommendationScopePlaylistId")
                        .OnDelete(DeleteBehavior.SetNull);
                });
            ...
            modelBuilder.Entity("Wisp.Core.Wanted.WantedTrack", b =>
                {
                    b.HasOne("Wisp.Core.Tracks.Track", "MatchedLocalTrack")
                        .WithMany()
                        .HasForeignKey("MatchedLocalTrackId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("MatchedLocalTrack");
                });
